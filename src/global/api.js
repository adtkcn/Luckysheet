...
export let validateCellData = dataVerificationCtrl.validateCellData.bind(dataVerificationCtrl)
export let getFailureText = dataVerificationCtrl.getFailureText.bind(dataVerificationCtrl)